...
uint32 PlayerbotAI::AutoScaleActivity(uint32 mod)
{
    ...
    if (maxDiff > 200) return (mod * 2) / 10;
    if (maxDiff > 150) return (mod * 3) / 10;
    if (maxDiff > 130) return (mod * 5) / 10;
    if (maxDiff > 100) return (mod * 6) / 10;
    if (maxDiff > 90)  return (mod * 7) / 10;
    if (maxDiff > 80)  return (mod * 8) / 10;
    if (maxDiff > 70)  return (mod * 9) / 10;
